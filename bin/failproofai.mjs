      ...
      await printHelp({
        ...
        sections: [
          ...
          },
          {
            ...
            lines: [
              "The date, in UTC: 2026.08.26. Publish again the same day and it is",
              "2026.08.26-2. You never pick a number and never decide whether",
              "something was a patch or a feature — a counter dressed as semver",
              "implied a distinction nothing enforced and nobody had made.",
              "",
              "It still ORDERS, which is what a version is for: zero-padded, so",
              "sorting the strings sorts the releases. Read from the repository's",
              "own releases rather than anything local, so a fresh clone is right.",
              "",
              "Never backwards. Two people publishing the same pack from Auckland",
              "and Los Angeles disagree about what day it is, so the next version",
              "is clamped to at least the highest already published — the second",
              "publisher continues that day's sequence instead of minting a lower",
              "version that is nonetheless newer.",
              "",
              "--version overrides it, and a tag on HEAD wins over the count —",
              "someone who tagged v1.2.0 has SAID what this release is. A tag names",
              "a COMMIT, so it is refused when the file has uncommitted changes:",
              "those bytes are not in that commit, and two packs would claim one",
              "version. Packs already published on semver keep every release",
              "installable by tag; they simply seed no date.",
            ],
          },
          {
            ...
            lines: [
              ...
              "",
              "Anyone can then install that exact release by commit:",
              "",
        ...
        sections: [
          ...
          },
          {
            ...
            lines: [
              ...
              "  acme/deploy-guard@2026.08.26             that release",
              "  acme/deploy-guard@a1b2c3d                the release built from",
              "                                           that commit",
              "  github:acme/deploy-guard@2026.08.26      same, explicit",
