...
<Tabs>
  <Tab title="Dashboard">
    1. Go to **Analyze → Queries**, create or open a saved query, and run it until the result is correct.
    2. Select **add to dashboard** on the query card or query detail page.
    3. Choose an existing dashboard, or go to **Analyze → Dashboards** and create one.
    4. Open the dashboard, enter edit mode, arrange tiles, and save the layout.
    5. Return to the query when you need to change the data or filters behind a tile.
