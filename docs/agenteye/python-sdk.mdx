...
Download the wheel from GitHub Releases using your `AGENTEYE_TOKEN`. If you do not yet have a token, see [enterprise-docs/github-token.md](/agenteye/github-token) for the setup steps and required permissions.
