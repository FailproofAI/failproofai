...
<Columns cols={2}>
  ...
  <Card title="Failproof Cloud CLI" icon="cloud-cog" href="/ar/reference/cloud-cli#أوامر-cli">
...
<Tabs>
  ...
  <Tab title="CLI">
    ...
    انظر إلى [مرجع Failproof AI CLI](/ar/reference/failproof-cli) لأوامر محلية و [مرجع Failproof Cloud CLI](/ar/reference/cloud-cli#أوامر-cli) لأوامر `fp`.
  </Tab>
</Tabs>