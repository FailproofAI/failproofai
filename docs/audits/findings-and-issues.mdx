...
pattern that survived them opens a **new** issue on the next audit run, so a fresh
start cannot quietly hide a problem you still have. When you do want a pattern
