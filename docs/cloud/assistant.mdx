...
Answers link to the sessions, saved queries, and dashboards used as evidence. The assistant
also uses the current page as context and keeps conversation history.

## Turn a good answer into a saved query or dashboard

The assistant can draft saved queries and dashboards. It writes them only after you select
**Approve**.
...
- [Charts and boards](/cloud/dashboards)
