...
If you have `alerts:write`, every row also carries a **+ alert** button. Click it and FailproofAI Cloud opens a new alert rule already filled in to catch that same failure again. The failure you just triaged becomes the one that pages you next time, instead of surprising you twice.
