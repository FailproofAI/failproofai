...
<Note>
  ...
  a git round-trip, see [cloud-managed policies](/cloud/policy-editor).
</Note>
...
2. [Cloud-managed policies](/cloud/policy-editor), if this machine is connected (digest-verified before each load)
