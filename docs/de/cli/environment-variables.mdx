...
| Variable | Beschreibung |
|----------|-------------|
| `FAILPROOF_API_URL` | Überschreibt die Basis-URL des API-Servers, die von dem Dashboard-Authentifizierungsdialog verwendet wird. Standardmäßig `https://api.befailproof.ai`; auf `http://localhost:8080` (oder einen anderen Wert) setzen, wenn ein lokaler API-Server verwendet wird. |
