...
Dies ist der Befehl, der in Claude Code's `settings.json` durch `failproofai policies --install` registriert wird. Normalerweise wird er nicht direkt aufgerufen.
