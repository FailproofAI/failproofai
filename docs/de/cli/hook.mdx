...
Liest eine JSON-Payload von stdin, wertet alle aktivierten Richtlinien aus und beendet sich mit einem Code, der die Entscheidung anzeigt:

| Exit-Code | Entscheidung | Auswirkung |
|-----------|--------------|------------|
| `0` | `allow` | Aktion erlauben |
| `1` | `deny` | Aktion blockieren – Claude erhält den Ablehnungsgrund |
| `2` | `instruct` | Hinweise in Claudes Kontext einfügen |
