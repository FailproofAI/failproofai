...
description: "Zeigt an, welche Richtlinien aktiviert sind, deren Parameter und benutzerdefinierte Richtlinien"
---
...
Zeigt alle Richtlinien mit ihrem Status, konfigurierten Parametern und benutzerdefinierten Richtlinien.
...
Unbekannte Schlüssel in `policyParams` werden hier angezeigt, damit Tippfehler frühzeitig erkannt werden können.