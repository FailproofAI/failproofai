...
<Tabs>
  <Tab title="Dashboard">
    ...
    2. Verbinden Sie die Maschine mit diesem Schlüssel — [Eine Maschine mit Cloud verbinden](/de/start/setup#eine-maschine-mit-der-cloud-verbinden) führt Sie durch den Vorgang.
