...
<Tabs>
  <Tab title="Dashboard">
    ...
    ![La segunda parte del formulario de nueva alerta con la lógica de infracciones, programación, severidad, canales de entrega y acción de creación.](/images/dashboard/alert-new-routing.png)
    ...
    ![La página de Alerts mostrando reglas de alerta con sus disparadores, ventanas de evaluación, canales y severidad.](/images/dashboard/alerts.png)
