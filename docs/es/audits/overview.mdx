...
<Tabs>
  <Tab title="Dashboard">
    ...
    ![La página de Audits muestra auditorías recurrentes con su programación, sensibilidad y estado de ejecución.](/images/dashboard/audits.png)
  </Tab>
  <Tab title="CLI">
    ```bash
    fp audits list
...
<Columns cols={2}>
  ...
  <Card title="Añadir contexto de agente" icon="bot" href="/es/audits/agent-contracts">
