...
| `--custom` / `-c` | Borrar `customPoliciesPath` de la configuración |

## Comportamiento

- **Sin nombres de políticas** — elimina todas las entradas de hooks de failproofai del archivo de configuración
