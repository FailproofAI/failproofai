...
<Steps>
  ...
  <Step title="Ejecutar tu agente">
    Inicia Claude Code como de costumbre. Si el agente intenta hacer algo arriesgado, failproofai lo intercepta automáticamente. Déjalo ejecutándose sin supervisión y revisa lo que ocurrió en el panel de control.
  </Step>
</Steps>
...
| `.failproofai/policies-config.json` | Configuración por proyecto (para hacer commit) |
