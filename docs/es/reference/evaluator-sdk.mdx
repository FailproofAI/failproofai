...
<Tabs>
  <Tab title="Panel de control">
    ...
    ![Vista detallada de una sesión que muestra las puntuaciones de evaluación y el razonamiento junto a su rastro.](/images/dashboard/session-detail.png)
    ...
    ![Panel de calidad con las puntuaciones del evaluador representadas a lo largo del tiempo.](/images/dashboard/dashboard-quality.png)
