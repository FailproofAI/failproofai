...
<Tabs>
  <Tab title="Panel de control">
    ...
    4. Selecciona el control de campana en un error representativo para configurar una alerta sobre errores similares.
...
- Determinar si una herramienta o modelo en particular provoca un pico.
- Ir desde un recuento agregado hasta sesiones representativas.
