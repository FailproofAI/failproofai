...
Usa Modelos para ver si la fiabilidad o el costo cambió con un modelo, agente, entorno o rango de tiempo.
...
<Tabs>
  ...
  <Tab title="CLI">
    ...
    Usa una consulta guardada para agregados a nivel de modelo que no están disponibles como un comando CLI dedicado.
  </Tab>
</Tabs>