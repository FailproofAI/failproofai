...
Las consultas son la capa flexible que sustenta los dashboards, auditorías e investigaciones. Usa SQL ad-hoc para probar una idea y guarda la consulta cuando pase a formar parte de un flujo de trabajo recurrente.
...
<Tabs>
  <Tab title="Dashboard">
    ...
    4. Guárdala con un nombre y descripción claros, y usa **add to dashboard** cuando el resultado deba ser monitoreado.
    ...
    Usa un nombre y descripción claros para que el resultado sea comprensible sin necesidad de abrir el SQL de nuevo.
  </Tab>
  <Tab title="CLI">
    ```bash
    fp query schema
...
- Crear una cohorte para una auditoría.

Abre **Queries → Schema** antes de escribir consultas sobre campos desconocidos. Utiliza filtros explícitos de tiempo y entorno, y mantén límites en los resultados durante la exploración.
