...
<Tabs>
  <Tab title="Panel de control">
    ...
    ![La página de herramientas mostrando la latencia, el desglose de éxitos y errores, y la distribución de llamadas a herramientas.](/images/dashboard/tools.png)
  </Tab>
  <Tab title="CLI">
    ```bash
    fp list tools
