...
`createFixtureEnv()` registra automáticamente la limpieza con `afterEach`.
...
| Instruct (excepto Stop) | `0` | `{"hookSpecificOutput":{"additionalContext":"Instruction from failproofai: ..."}}` |
