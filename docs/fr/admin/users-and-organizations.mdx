...
description: "Gérez les membres et assurez que les données et actions de chaque organisation restent bien isolées."
icon: "users"
---
...
<Tabs>
  <Tab title="Tableau de bord">
    ...
    4. Ouvrez un utilisateur ultérieurement pour mettre à jour les droits, désactiver la connexion ou réactiver le compte.
