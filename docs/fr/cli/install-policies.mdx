...
Écrit des entrées de hooks dans le fichier de paramètres du CLI agent installé (Claude Code, OpenAI Codex, ou GitHub Copilot CLI _(bêta)_) afin que failproofai intercepte les appels d'outils.
...
| Flag | Description |
|------|-------------|
| `--cli claude\|codex\|copilot` | CLI(s) agent pour lesquels installer ; séparés par des espaces (ex. `--cli claude codex copilot`) ou répétés. Omettez cette option pour détecter les CLIs installés et afficher une invite. |
