...
|------|-------------|
| `--cli claude\|codex\|copilot` | CLI(s) d'agent pour lesquels installer ; séparés par des espaces (ex. `--cli claude codex copilot`) ou répétés. Omettre pour détecter les CLIs installés et afficher une invite. |
...
- **Sans nom de politique** — ouvre une invite interactive pour sélectionner les politiques
