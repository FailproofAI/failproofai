...
Supprime les entrées de hooks failproofai du fichier `settings.json` de Claude Code.
...
| `--scope all` | Supprimer de tous les niveaux à la fois |
| `--custom` / `-c` | Effacer le `customPoliciesPath` de la configuration |

## Comportement

- **Sans nom de politique** - supprime toutes les entrées de hooks failproofai du fichier de paramètres
