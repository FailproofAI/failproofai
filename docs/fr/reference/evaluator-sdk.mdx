...
description: "Créez un service qui évalue les sessions Failproof AI de façon synchrone ou asynchrone."
icon: "gauge"
---
...
<Tabs>
  <Tab title="Tableau de bord">
    ...
    ![Un tableau de bord qualité représentant graphiquement les scores de l'évaluateur au fil du temps.](/images/dashboard/dashboard-quality.png)
