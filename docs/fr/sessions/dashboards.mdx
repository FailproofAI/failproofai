...
Les tableaux de bord combinent des requêtes sauvegardées en une vue opérationnelle. Construisez-en un autour d'une décision que vous attendez de quelqu'un — pas autour de chaque métrique disponible.
...
<Tabs>
  <Tab title="Tableau de bord">
    ...
    4. Revenez à la requête lorsque vous devez modifier les données ou les filtres derrière une tuile.
  ...
  <Tab title="CLI">
    Le CRUD des tableaux de bord n'est pas exposé par le CLI Cloud actuel. Utilisez le CLI pour construire et vérifier la requête sauvegardée, puis ajoutez-la à un tableau de bord dans l'interface.
