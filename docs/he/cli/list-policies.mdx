...
מציג את כל המדיניויות עם הסטטוס שלהן, הפרמטרים המוגדרים, והמדיניויות המותאמות.
...
מפתחות לא מוכרים ב-`policyParams` מסומנים כאן כדי שתוכל לתפוס שגיאות הקלדה מוקדם.