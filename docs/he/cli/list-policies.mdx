...
מציג את כל המדיניויות עם סטטוס שלהן, פרמטרים שהוגדרו, ומדיניויות מותאמות אישית.
...
מפתחות לא ידועים ב-`policyParams` מתויגים כאן כדי שתוכל לתפוס שגיאות הקלדה מוקדם.