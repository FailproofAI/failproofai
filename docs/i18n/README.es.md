...
| `sanitize-api-keys` | Claves API que se filtran al contexto del agente |
...
MIT con [Commons Clause](https://commonsclause.com/) — libre para uso interno y personal; la reventa comercial de failproofai requiere un acuerdo separado. Consulta [LICENSE](../../LICENSE) para el texto completo.
