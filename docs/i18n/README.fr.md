...
→ [Les 30 politiques intégrées](https://docs.befailproof.ai/policies/builtin)
...
| | |
|---|---|
| [Démarrage rapide](https://docs.befailproof.ai/start/quickstart) | Installation et premiers pas |
| [Politiques intégrées](https://docs.befailproof.ai/policies/builtin) | Les 30 politiques avec leurs paramètres |
...
| [Tableau de bord](https://docs.befailproof.ai/sessions/overview) | Moniteur de session et activité des politiques |
| [Architecture](https://docs.befailproof.ai/start/concepts) | Fonctionnement du système de hooks |
