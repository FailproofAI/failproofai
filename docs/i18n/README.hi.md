...
Claude Code और Codex में हुक करता है। लूप्स, खतरनाक कार्यों, और सीक्रेट लीक को
घटना बनने से पहले पकड़ता है। शून्य लेटेंसी। स्थानीय रूप से चलता है।
...
30 बिल्ट-इन पॉलिसीज तुरंत सक्रिय हो जाती हैं। डैशबोर्ड `localhost:8020` पर उपलब्ध है। `FAILPROOFAI_NO_FIRST_RUN=1` से पहली बार चलाने का प्रॉम्प्ट अक्षम करें।

---

## यह क्या रोकता है

| पॉलिसी | जो ब्लॉक करता है |
|---|---|
...
| `sanitize-api-keys` | API कीज़ एजेंट कॉन्टेक्स्ट में लीक होना |

→ [सभी 30 बिल्ट-इन पॉलिसीज](https://docs.befailproof.ai/built-in-policies)

---

## अपनी स्वयं की पॉलिसीज
...
| `instruct(message)` | इसे जाने दें, लेकिन एजेंट के अगले प्रॉम्प्ट में कॉन्टेक्स्ट जोड़ें |

→ [कस्टम पॉलिसीज गाइड](https://docs.befailproof.ai/custom-policies)
...
क्या ब्लॉक किया गया, और पॉलिसी ने एजेंट को क्या बताया — इसलिए जब कुछ गलत हो जाता है तो आप अनुमान नहीं लगा रहे होते।
...
| [बिल्ट-इन पॉलिसीज](https://docs.befailproof.ai/built-in-policies) | सभी 30 पॉलिसीज पैरामीटर के साथ |
| [कस्टम पॉलिसीज](https://docs.befailproof.ai/custom-policies) | अपनी स्वयं की लिखें |
| [कॉन्फ़िगरेशन](https://docs.befailproof.ai/configuration) | कॉन्फ़िग स्कोप और मर्ज नियम |
| [डैशबोर्ड](https://docs.befailproof.ai/dashboard) | सेशन मॉनिटर और पॉलिसी एक्टिविटी |
...
MIT with [Commons Clause](https://commonsclause.com/) — आंतरिक और व्यक्तिगत उपयोग के लिए निःशुल्क; failproofai को वाणिज्यिक रिसेल के लिए अलग समझौते की आवश्यकता है। पूर्ण पाठ के लिए [LICENSE](../../LICENSE) देखें।

---

## योगदान

[CONTRIBUTING.md](../../CONTRIBUTING.md) देखें। नई पॉलिसीज, एज केसेज, और अनुवाद सभी स्वागत हैं।

> **शुरू करने से पहले बिल्ड करें।** पहले `bun install && bun run build` चलाएं। यह रिपो failproofai के स्वयं के हुक्स को अपने पर चलाता है, और वे `failproofai` आयात को संकलित `dist/` बंडल के विरुद्ध हल करते हैं — एक बिल्ड के बिना आपको `Cannot find package 'failproofai'` हुक त्रुटियां मिलेंगी। `src/` में परिवर्तन के बाद पुनः बिल्ड करें। [इन-रिपो देव हुक्स को काम करने से पहले बिल्ड करें](../../CONTRIBUTING.md#build-before-the-in-repo-dev-hooks-will-work) देखें।
