...
커밋해 두면 다음 풀(pull) 시 팀 전체에 적용됩니다.
...
| [아키텍처](https://docs.befailproof.ai/architecture) | 훅 시스템 동작 원리 |
...
> failproofai 자체 훅을 스스로에게 적용하며, `failproofai` 임포트를 컴파일된 `dist/` 번들에서
