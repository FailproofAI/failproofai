...
| [Dashboard](https://docs.befailproof.ai/sessions/overview) | Monitor de sessão e atividade de políticas |
| [Arquitetura](https://docs.befailproof.ai/start/concepts) | Como o sistema de hooks funciona |
