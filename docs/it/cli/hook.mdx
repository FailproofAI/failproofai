...
description: "Il subprocess che Claude Code chiama per ogni evento tool"
---
...
| `2` | `instruct` | Inietta linee guida nel contesto di Claude |
...
| **Ciclo di vita sessione** | `SessionStart`, `SessionEnd`, `Stop`, `StopFailure` |
