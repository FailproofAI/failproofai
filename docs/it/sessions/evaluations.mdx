...
<Tabs>
  <Tab title="Dashboard">
    ...
    ![Una dashboard di qualità che mostra i punteggi di valutazione medi e i trend nel tempo.](/images/dashboard/dashboard-quality.png)

    Apri una sessione dal drill-down per ispezionare il ragionamento per ogni punteggio:

    ![Una vista di dettaglio della sessione che mostra i punteggi di valutazione e il ragionamento accanto alla traccia completa.](/images/dashboard/session-detail.png)
  </Tab>
  <Tab title="CLI">
    ```bash
