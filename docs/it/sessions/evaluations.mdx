...
description: "Valuta sessioni live e completate per qualità, conformità, costi e latenza."
icon: "gauge"
---
...
<Tabs>
  <Tab title="Dashboard">
    ...
    ![Un dashboard di qualità che mostra i punteggi di valutazione medi e i trend nel tempo.](/images/dashboard/dashboard-quality.png)

    Apri una sessione dal drill-down per ispezionare il suo ragionamento per punteggio:

    ![Una vista dettagli sessione che mostra i punteggi di valutazione e il ragionamento accanto alla traccia completa.](/images/dashboard/session-detail.png)
  </Tab>
  <Tab title="CLI">
    ```bash
