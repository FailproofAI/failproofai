...
Grava entradas de hook no arquivo de configurações do CLI do agente instalado (Claude Code, OpenAI Codex ou GitHub Copilot CLI _(beta)_) para que o failproofai intercepte as chamadas de ferramenta.
