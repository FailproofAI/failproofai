...
Insere entradas de hook no arquivo de configurações do agente CLI instalado (Claude Code, OpenAI Codex ou GitHub Copilot CLI _(beta)_) para que o failproofai intercepte as chamadas de ferramenta.
