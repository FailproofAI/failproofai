...
Use o hook de notificação para encaminhar alertas de inatividade para o Slack.
...
Faça commit de uma configuração no nível do projeto para que todos os desenvolvedores da sua equipe usem as mesmas políticas.
...
<Steps>
  ...
  <Step title="Continue evoluindo">
    À medida que sua equipe encontrar novos problemas, adicione políticas e faça push. Todos recebem a atualização no próximo `git pull`. Essas políticas se tornam um padrão de qualidade vivo que cresce junto com a sua equipe.
  </Step>
</Steps>
...
| `policies-advanced/index.js` | Importações transitivas, hooks assíncronos, limpeza de saída com PostToolUse e tratamento do evento Stop |