---
title: Exemplos
description: "Como configurar hooks para o Claude Code e o Agents SDK"
icon: book-open
---
...
<Steps>
  ...
  <Step title="Verificar se os hooks estão registrados">
    ```bash
...
Impeça que agentes vejam ou vazem credenciais na saída de ferramentas.

```bash
failproofai policies --install sanitize-api-keys sanitize-jwt sanitize-connection-strings sanitize-bearer-tokens
```

Essas políticas são disparadas no `PostToolUse` — após uma ferramenta ser executada, elas limpam a saída antes que o agente a veja.
...
Lembre os agentes de executar testes antes de fazer commit.
...
Faça commit de uma configuração no nível do projeto para que todos os desenvolvedores do time usem as mesmas políticas.
...
<Steps>
  ...
  <Step title="Continuar aprimorando">
    À medida que o time encontrar novos problemas, adicione políticas e faça push. Todos recebem a atualização no próximo `git pull`. Essas políticas se tornam um padrão de qualidade vivo que cresce junto com o time.
  </Step>
</Steps>
