...
|------|---------------------|
| Policies | Nomes de políticas integradas, tipos de eventos, parâmetros, ativar/desativar |
...
O Mintlify gera o `llms.txt` a partir de todas as páginas da navegação. A documentação do Failproof AI cobre a API completa — cada política, opção e exemplo está incluído. Se você encontrar algo faltando, o conteúdo fonte está em `https://docs.befailproof.ai/llms-full.txt`.
