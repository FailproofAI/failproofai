---
title: "Para agentes"
description: "Adicione o conhecimento do Failproof AI ao seu agente de codificação com um único comando. Funciona com Claude Code, Cursor, Windsurf e muito mais."
---
...
O Mintlify gera o `llms.txt` a partir de todas as páginas da navegação. A documentação do Failproof AI cobre a API completa — cada política, opção e exemplo está incluído. Se encontrar algo faltando, a fonte está em `https://docs.befailproof.ai/llms-full.txt`.

Para contexto mais específico, aponte diretamente para uma página em particular:
