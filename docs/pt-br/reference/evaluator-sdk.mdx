---
title: "Evaluator SDK"
description: "Construa um serviço que avalia sessões do Failproof AI de forma síncrona ou assíncrona."
icon: "gauge"
---
...
<Tabs>
  <Tab title="Dashboard">
    Abra uma sessão concluída em **Observe → Sessions** e selecione **Run evaluation** se ela não foi avaliada automaticamente. Revise o status, as pontuações, o raciocínio e o resumo no painel **Evaluation** da sessão.
    ...
    ![Uma visualização de detalhe de sessão mostrando pontuações de avaliação e raciocínio ao lado do trace.](/images/dashboard/session-detail.png)
    ...
    ![Um dashboard de qualidade com gráficos de pontuações do avaliador ao longo do tempo.](/images/dashboard/dashboard-quality.png)
...
A avaliação automática é global para o deployment e permanece desabilitada quando `EVALUATOR_ENDPOINT` não está definido.
...
| `EVALUATOR_WORKERS` | `2` | Workers do dispatcher em execução simultânea. |
