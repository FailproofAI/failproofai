...
<Tabs>
  ...
  <Tab title="CLI">
    Set the machine up — this wires hooks for every detected harness, installs the daemon, and connects to Cloud:

    ```bash
    FAILPROOFAI_CLOUD_TOKEN=<machine-key> failproofai config
