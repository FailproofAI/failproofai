...
A harness is whatever your agent actually runs inside. Failproof AI supports twelve of them, across three classes:

- **Coding CLIs** — Claude Code, Codex, GitHub Copilot CLI, Cursor, OpenCode, Pi, Factory Droid, Devin CLI, Antigravity CLI, Goose
- **Chat and assistant gateways** — Hermes (Slack, Telegram, cron), OpenClaw (self-hosted assistant)
- **Your own agents** — anything instrumented with the [Python SDK](/reference/python-sdk)
