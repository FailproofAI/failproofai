...
<Steps>
  ...
  <Step title="Install agent hooks and policies">
    This attaches Failproof AI to your harness and installs the 40 built-in policies. Use them to see local policy decisions and try enforcement before Failproof AI audits your sessions and writes policies for your agents.
