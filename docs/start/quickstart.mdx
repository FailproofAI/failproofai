...
**Which path is yours?** If your agent runs in one of the 12 supported [harnesses](/reference/harnesses) — a coding CLI, or a gateway like Hermes or OpenClaw — follow the steps below; you need Node.js 20.9 or later. If your agent has no harness, instrument it directly with the [Python SDK](/reference/python-sdk) and then rejoin at [Run your first failure check](/start/first-audit).
