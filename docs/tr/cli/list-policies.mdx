...
description: "Hangi politikaların etkinleştirildiğini, parametrelerini ve özel politikaları göz önüne alın"
---
...
Tüm politikaları durumu, yapılandırılmış parametreleri ve özel politikaları ile birlikte gösterir.
...
`policyParams` içindeki bilinmeyen anahtarlar burada işaretlenmiş olup, yazım hataları nedeniyle erken uyarı alabilirsiniz.