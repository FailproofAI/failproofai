// Vercel AI SDK 7.x: every commonly used surface. Run as `node surfaces.{mjs,cjs} <case>`.
//
...
// --- version-specific: ai 7 (LanguageModelV4, ToolLoopAgent, needsApproval; no OpenTelemetry)
...
type Content = Awaited<ReturnType<MockLanguageModelV4["doGenerate"]>>["content"][number];
