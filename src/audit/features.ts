 ...
 * full coverage. The six hard-floor builtins added for the two-tier Jev
 * evaluator (block-disk-destruction, block-gh-destructive, block-mass-kill,
 * block-no-verify, block-indirect-exec, block-chmod-777) are deliberately NOT
