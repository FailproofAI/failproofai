...
export const POLICY_CATALOG: PolicyCatalogEntry[] = [
  ...
  },
  {
    ...
    description: "Block killing processes en masse (killall/pkill of interpreters, shells or broad patterns, pkill -u, kill -1, kill fed by a broad pgrep)",
    match: { events: ["PreToolUse"], toolNames: ["Bash"] },
    defaultEnabled: false,
    category: "Dangerous Commands",
    authority: "hard",
  },
  {
    ...
    description: "Block bypassing git hooks (git commit/push --no-verify, git commit -n, core.hooksPath overrides, HUSKY=0)",
    match: { events: ["PreToolUse"], toolNames: ["Bash"] },
    defaultEnabled: false,
    category: "Git",
    authority: "hard",
